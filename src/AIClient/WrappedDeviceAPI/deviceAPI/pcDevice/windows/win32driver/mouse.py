...
# [GCC 9.3.0]
# Embedded file name: ../../aisdk2/game_ai_sdk/tools/phone_aiclientapi/WrappedDeviceAPI/deviceAPI/pcDevice/windows/win32driver/mouse.py
...
_cursor_flags = {0: win32con.IDC_ARROW, 
 1: win32con.IDC_HAND, 
 2: win32con.IDC_WAIT, 
...
_mouse_msg = {MouseFlag.LeftButton: [win32con.MOUSEEVENTF_LEFTDOWN, win32con.MOUSEEVENTF_LEFTUP], 
...
_mouse_msg_param = {MouseFlag.LeftButton: [win32con.WM_LBUTTONDOWN, win32con.WM_LBUTTONUP, 1, win32con.WM_LBUTTONDBLCLK], 
...
_mouse_ncmsg_param = {MouseFlag.LeftButton: [win32con.WM_NCLBUTTONDOWN, win32con.WM_LBUTTONUP, 1, win32con.WM_NCLBUTTONDBLCLK]}
...
class Mouse(object):
    ...
    @staticmethod
    def click(x, y, flag=MouseFlag.LeftButton, click_type=MouseClickType.SingleClick):
        """鼠标点击(x,y)点
    ...
    @staticmethod
    def send_click(hwnd, x, y, flag=MouseFlag.LeftButton, click_type=MouseClickType.SingleClick):
        ...
        """
        keystate = 0
        if win32api.GetAsyncKeyState(win32con.VK_CONTROL) & 32768 != 0:
            keystate = keystate | win32con.MK_CONTROL
        if win32api.GetAsyncKeyState(win32con.VK_SHIFT) & 32768 != 0:
        ...
        if click_type == MouseClickType.SingleClick:
            try:
                ...
                if e.winerror == 1400:
                    ...
                    if e.winerror == 1460:
                        win32gui.SendMessageTimeout(hwnd, win32con.WM_NULL, 0, 0, 0, 30000)
                    else:
                        raise e
    ...
    @staticmethod
    def post_click(hwnd, x, y, flag=MouseFlag.LeftButton, click_type=MouseClickType.SingleClick):
