...
#ifndef GAME_AI_SDK_IMGPROC_UI_ACTION_ACTION_H_
#define GAME_AI_SDK_IMGPROC_UI_ACTION_ACTION_H_
...
class CAction : public TSingleton<CAction> {
  public:
    ...
    /*!
      * @brief 初始化
      * @param[in] eTestMode
      * @param[char*] pszUserCfgPath
      * @return true表示成功，false表示失败
    */
    bool Initialize(ETestMode eTestMode, const char* pszUserCfgPath);
    ...
    /*!
      ...
      * @return true表示成功，false表示失败
    */
    bool DoAction(const tagFrameContext &stFrameCtx, tagUIRegResult &stUIRegRst,
  ...
  private:
    /*!
      ...
      * @return true表示成功，false表示失败
    */
    bool DoClickAction(const tagFrameContext &stFramectx, const tagUIState &stSrcUIState,
    ...
    */
    ...
    /*!
      ...
      * @return true表示成功，false表示失败
    */
    bool DoAction(const tagFrameContext &stFramectx, tagUIState &stSrcUIState,
...
#endif   // GAME_AI_SDK_IMGPROC_UI_ACTION_ACTION_H_
