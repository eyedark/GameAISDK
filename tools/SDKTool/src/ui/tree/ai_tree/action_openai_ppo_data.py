...
from ....common.define import OPENAI_ACTION_TYPES, CONTACTS, AI_ACTION_TYPES
...
class OpenAIPPOActionData(ActionData):
    @staticmethod
    def get_game_action_inner():
        return AIManager().get_game_action(AIAlgorithmType.OPENAI_PPO)

    @staticmethod
    def get_ai_action_inner():
        return AIManager().get_ai_action(AIAlgorithmType.OPENAI_PPO)
